...
<body>
    ...
    {{-- javascript code --}}
    <script
        src="https://maps.google.com/maps/api/js?key=AIzaSyAQnHeGngUfGGQywrjPx8Y3B3odnVdXZEY&libraries=places{{--&callback=initAutocomplete--}}"
        type="text/javascript"></script>
    {{-- <script src="https://maps.googleapis.com/maps/api/js?AIzaSyDxTV3a6oL6vAaRookXxpiJhynuUpSccjY&libraries=places">
    </script> --}}
    <script>
